					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Übung Kommentare",
									"targetURL": "#myfioriapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"myfioriapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myfioriapp",
									"url": sap.ui.require.toUrl("myfioriapp")
								}
							}
						}
					}
